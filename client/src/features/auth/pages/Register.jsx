...
const Register = () => {
    ...
    const addResearchArea = () => {
        if (newArea.trim() && !formData.researchAreas.includes(newArea.trim())) {
            setFormData(prev => ({ ...prev, researchAreas: [...prev.researchAreas, newArea.trim()] }))
            setNewArea('')
        }
    }
    ...
    const handleSubmit = async (e) => {
        ...
        if (signupData.gpa) {
            signupData.gpa = parseFloat(signupData.gpa)
        } else {
            signupData.gpa = null
        }
